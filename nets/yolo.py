...
from nets.darknet import BaseConv, CSPDarknet, CSPLayer, DWConv, RepConv, fuse_conv_and_bn
...
class YOLOXHead(nn.Module):
    def __init__(self, num_classes, width = 1.0, in_channels = [256, 512, 1024], act = "silu", depthwise = False,):
        ...
        for i in range(len(in_channels)):
            self.Conv_rep.append(conv_rep(c1=int(in_channels[i] * width), c2=int(256 * width)))
